// TODO: need to fix typescript error
// @ts-nocheck

const nameStart = /[A-Za-z_:\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/;
const nameBody = /[A-Za-z_:\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]/;
const entityStart = /[A-Za-z_]/;
const entityBody = /[A-Za-z0-9._:-]/;

const ENTITIES: { [key: string]: number | string } = {
  ...
  // HTML entities from http://www.w3.org/TR/html4/sgml/entities.html
  // Latin-1
  AElig: 198,
  Aacute: 193,
  Acirc: 194,
...
export class SAX implements SAXInterface {
  ...
  protected parser: (strict: boolean, opt: any) => SAXParser;
  private CDATA = '[CDATA[';
